...
# TODO(allie): reimplement or include officially (according to license)
# Borrowed from
# https://github.com/mapillary/mapillary_vistas/blob/master/mapillary_vistas/evaluation/confusion_matrix.py
