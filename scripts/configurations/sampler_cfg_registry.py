...
def get_sampler_cfg_set(n_images_train=None, n_images_val=None, n_images_train_for_val=None,
                        sem_cls_filter_names=None,
                        n_instances_ranges=None, val_copy_train=False):
    assert val_copy_train is False or n_images_val is None
    train_sampler_cfg = SamplerConfigWithoutValues(n_images=n_images_train, sem_cls_filter_names=sem_cls_filter_names,
                                                   n_instances_ranges=n_instances_ranges)
    val_sampler_cfg = SamplerConfigWithoutValues(n_images=n_images_val, sem_cls_filter_names=sem_cls_filter_names,
                                                 n_instances_ranges=n_instances_ranges) if not val_copy_train else \
        train_sampler_cfg
