...
class FCN8sInstance(nn.Module):
    ...
    def __init__(self, n_semantic_classes=21, n_max_per_class=3, n_single_instance_classes=2):
        super(FCN8sInstance, self).__init__()
        n_classes = n_semantic_classes + n_single_instance_classes
        ...
        self.score_fr = nn.Conv2d(4096, n_classes, 1)  # H/32 x W/32 x n_semantic_cls
        self.score_pool3 = nn.Conv2d(256, n_classes, 1)   # H/32 x W/32 x n_semantic_cls
        self.score_pool4 = nn.Conv2d(512, n_classes, 1)   # H/32 x W/32 x n_semantic_cls
    ...
    def copy_params_from_fcn8s(self, vgg16):
        logger.info('Copying params from fcn8s')
